...
class CombatTest {
	...
	@Test
	void super_complicated_three() {
		Warrior warriorOne = new DefensiveWarrior.Builder(2).attack(4).defense(16).build();
		Warrior warriorTwo = new AggressiveWarrior.Builder(2).attack(4).defense(20).build();
		Warrior winner = combat.duel(warriorOne, warriorTwo);
		assertSame(warriorTwo, winner);
	}
}
